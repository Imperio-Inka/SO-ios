...
open class SwiftAddressBookPerson : SwiftAddressBookRecord {
	...
	open class func createInSourceWithVCard(_ source : SwiftAddressBookSource, vCard : String) -> [SwiftAddressBookPerson]? {
		...
		if let persons = abPersons {
			for person : ABRecord in persons as NSArray? {
	...
	open var birthday : Date? {
		...
		set {
            setSingleValueProperty(kABPersonBirthdayProperty, newValue as NSDate?)
		}
	}
	...
	open var creationDate : Date? {
		...
		set {
            setSingleValueProperty(kABPersonCreationDateProperty, newValue as NSDate?)
	...
	open var modificationDate : Date? {
		...
		set {
			setSingleValueProperty(kABPersonModificationDateProperty, newValue as NSDate?)
		}
	}
	...
	open var dates : Array<MultivalueEntry<Date>>? {
		...
		set {
			setMultivalueProperty(kABPersonDateProperty, newValue as NSArray?)
		}
	}
