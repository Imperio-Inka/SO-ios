...
/** array of bytes */
extension UInt32 {
    public func bytes(_ totalBytes: Int = MemoryLayout<UInt32>.size) -> Array<UInt8> {
    ...
    public static func withBytes(_ bytes: Array<UInt8>) -> UInt32 {
...
extension UInt32 {
    ...
    fileprivate mutating func shiftRight(_ count: UInt32) -> UInt32 {
        ...
        let bitsCount = UInt32(MemoryLayout.size(ofValue: self) * 8)
