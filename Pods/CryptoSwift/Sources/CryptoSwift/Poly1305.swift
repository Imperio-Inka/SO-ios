...
final public class Poly1305 {
     ...
     */
    public func authenticate(_ message:Array<UInt8>) -> Array<UInt8>? {
        if let ctx = self.ctx {
    ...
    */
    fileprivate func update(_ context:Context, message:Array<UInt8>, bytes:Int? = nil) {
    ...
    fileprivate func finish(_ context:Context) -> Array<UInt8>? {
    ...
    fileprivate func add(_ context:Context, c:Array<UInt8>) -> Bool {
    ...
    fileprivate func squeeze(_ context:Context, hr:Array<UInt32>) -> Bool {
    ...
    fileprivate func blocks(_ context:Context, m:Array<UInt8>, startPos:Int = 0) -> Int {
        var bytes = m.count
