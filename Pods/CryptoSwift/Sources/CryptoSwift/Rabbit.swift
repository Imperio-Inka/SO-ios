...
final public class Rabbit: BlockCipher {
    ...
    /// State variables
    fileprivate var x = Array<UInt32>(repeating: 0, count: 8)
    
    /// Counter variables
    fileprivate var c = Array<UInt32>(repeating: 0, count: 8)
    
    /// Counter carry
    fileprivate var p7: UInt32 = 0
    
    /// 'a' constants
    fileprivate var a: Array<UInt32> = [
        0x4D34D34D,
        0xD34D34D3,
        0x34D34D34,
        0x4D34D34D,
    ...
    fileprivate func setupIV(_ iv: Array<UInt8>) {
